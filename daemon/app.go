...
var (
	...
	DefaultCLIHome = os.ExpandEnv("$HOME/.daemoncli")
	
	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.daemon")
...
func NewDaemonApp(
	...
	keys := sdk.NewKVStoreKeys(bam.MainStoreKey, auth.StoreKey, staking.StoreKey,
		supply.StoreKey, distr.StoreKey, slashing.StoreKey, params.StoreKey, daemon.StoreKey)
	...
	app.daemonKeeper = daemon.NewKeeper(
		keys[daemon.StoreKey],
		app.cdc,
	)
	...
	app.mm = module.NewManager(
		...
		daemon.NewAppModule(app.daemonKeeper),
	)
...
func (app *daemonApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
	...
	fmt.Println("**** ExportAppStateAndValidators :: Validators::", validators)
